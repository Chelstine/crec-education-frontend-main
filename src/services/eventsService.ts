...
export const eventsService = {
  ...
  getAllAdmin: async (): Promise<Event[]> => {
    const response = await axios.get(`${API_URL}/admin/content/events`, {
      headers: {
  ...
  create: async (data: CreateEventData): Promise<Event> => {
    ...
    const response = await axios.post(`${API_URL}/admin/content/events`, formData, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem('auth_token')}`,
  ...
  update: async (id: number, data: Partial<UpdateEventData>): Promise<Event> => {
    ...
    try {
      ...
      const response = await axios.post(`${API_URL}/admin/content/events/${id}`, formData, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('auth_token')}`,
          'Content-Type': 'multipart/form-data'
        }
  ...
  delete: async (id: number): Promise<void> => {
    await axios.delete(`${API_URL}/admin/content/events/${id}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem('auth_token')}`
      }
    });
  ...
  toggleStatus: async (id: number): Promise<Event> => {
    const response = await axios.patch(`${API_URL}/admin/content/events/${id}/toggle-status`, {}, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem('auth_token')}`
      }
    });
  ...
  getStats: async () => {
    const response = await axios.get(`${API_URL}/admin/content/events/stats`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem('auth_token')}`,
        'Accept': 'application/json'
      }
  ...
  getById: async (id: number): Promise<Event> => {
    const response = await axios.get(`${API_URL}/admin/content/events/${id}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem('auth_token')}`,
        'Accept': 'application/json'
      }
