      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-6 pb-6 border-b border-slate-700/30">
          ...
          <div className="flex flex-col items-center md:items-start">
            <Link to="/istmr" className="flex items-center gap-4 mb-4 bg-white/5 p-3 rounded-lg border border-white/10 group transition-all hover:bg-white/10">
              <img src="/img/logo.png" alt="CREC" className="h-8 w-auto opacity-80" />
              <div className="w-px h-6 bg-crec-gold/30" />
              <img src="/img/logo_istmr.png" alt="ISTMR" className="h-10 w-auto" />
            </Link>
          ...
          <div className="hidden md:block">
            <ul className="flex flex-wrap justify-center gap-4 text-sm">
              ...
              <li><Link to="/istmr" className="text-slate-300 hover:text-white transition">{t('nav.formations')}</Link></li>
