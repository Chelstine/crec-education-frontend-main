              ...
              <div className="max-w-4xl mx-auto px-6">
                ...
                >
                  ...
                  <p>
                    ...
                    spirituelle, notamment à travers le Centre de Recherche, d'Étude et de Créativité (CREC).
                  </p>
                    ...
                    {timelineEvents.map((event, i) => (
                      ...
                      >
                        <div className={`md:w-1/2 ${i % 2 === 0 ? 'md:pr-8 md:text-right' : 'md:pl-8'} w-full ${event.isSubEvent ? 'md:w-5/12 md:ml-auto' : ''}`}>
                          <Card className={`shadow-md ${event.isAfricaEvent
                            ...
                            <CardContent className="p-4">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <h3 className={`text-xl font-semibold mb-0 ${event.isAfricaEvent ? 'text-green-800' : 'text-amber-800'
                              ...
                              <p className={`text-slate-700 leading-relaxed ${event.isSubEvent ? 'text-sm' : 'text-base'
                                }`}>
                                {event.desc}
                              </p>
                            </CardContent>
                        ...
                        <div className={`hidden md:block absolute left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full border-4 border-white shadow-md ${event.isAfricaEvent
                            ? 'bg-green-600'
                            : 'bg-amber-600'
                        ...
                        {event.isSubEvent && (
                          <div className={`hidden md:block absolute left-1/2 w-8 h-0.5 bg-green-400 ${i % 2 === 0 ? 'transform -translate-x-full' : ''
                            }`}></div>
                        )}
                      </div>
                    ))}
