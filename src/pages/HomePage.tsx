    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white text-slate-900">
      ...
      <section className="relative w-full overflow-hidden">
          ...
          {heroImages.map((img, i) => (
            ...
            >
              <div
                ...
                style={{ '--hero-bg': `url(${img})` } as React.CSSProperties}
              />
            </motion.div>
          ))}
        </div>

        {/* Overlay gradient - opacité réduite pour une visibilité maximale des images */}
        <div className="absolute inset-0 bg-gradient-to-r from-crec-darkblue/30 via-transparent to-crec-darkblue/30 z-[3]" />
        ...
        <motion.div
          ...
          className="absolute top-20 right-20 w-64 h-64 rounded-full bg-crec-gold z-[4]"
        />
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.1 }}
          transition={{ duration: 1.5, delay: 0.3 }}
          className="absolute bottom-10 left-10 w-96 h-96 rounded-full bg-blue-500 z-[4]"
        />
        ...
        <div className="min-h-[350px] md:min-h-[400px] flex flex-col items-center justify-center text-center relative z-[5] text-white p-6 md:p-10">
          ...
          >
            <motion.div
              ...
              className="mb-4 inline-flex px-4 py-2 rounded-full items-center bg-white/10 border border-white/20"
            >
              <motion.div
                animate={{
                  scale: [1, 1.05, 1],
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
              <Button
                size="lg"
                className="rounded-full px-8 py-4 bg-crec-gold hover:bg-amber-500 text-white font-semibold shadow-xl border border-amber-400/30 transition-all duration-300 text-lg"
              ...
              <Button
                asChild
                size="lg"
                className="rounded-full px-8 py-4 bg-white/20 hover:bg-white/30 text-white font-semibold shadow-xl border border-white/20 transition-all duration-300 text-lg"
              >
                <Link to="/about">
                  ...
                  <div className="flex space-x-2 md:space-x-4 mb-6 border-b border-slate-200">
                    {tabSections.map((tab, idx) => (
                      <button
                        ...
                        className={`flex items-center gap-2 px-4 py-3 font-medium text-sm transition-colors duration-200 border-b-2 ${activeTab === idx
