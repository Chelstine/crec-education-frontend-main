...
const CampusLifePage = () => {
  ...
  return (
      ...
      <div className="min-h-screen flex flex-col font-sans text-[15pt] bg-gradient-to-b from-amber-50 to-white">
        {/* Hero Section (Formatted like ProgramsPage.tsx) */}
        <section className="relative w-full">
          ...
          <div
            ...
            style={{
              backgroundImage: "url('/img/campus-life-bg.jpg')",
          ...
          >
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight">Vivez l’expérience CREC</h1>
              <p className="text-xl md:text-2xl mb-6 leading-relaxed">
                Une communauté jésuite dynamique où culture, spiritualité et engagement s’épanouissent au Bénin.
              </p>
              <motion.div
