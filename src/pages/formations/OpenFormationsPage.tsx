      ...
      <section className="relative w-full min-h-[260px] md:min-h-[320px] overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center h-full text-center px-4 py-16">
          <motion.div 
            ...
            className="max-w-2xl mx-auto bg-gradient-to-br from-black/50 to-crec-blue/40 p-10 rounded-xl backdrop-blur-md border border-white/10 shadow-2xl"
          >
            <div className="text-crec-gold text-sm uppercase tracking-widest mb-2">Formation Continue</div>
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-4">
              <Badge variant="secondary" className="text-lg py-2 px-4 bg-white/20 backdrop-blur-sm">
